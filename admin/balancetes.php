...
$sql = "SELECT b.*, c.nome as categoria_nome 
        FROM balancetes b 
        LEFT JOIN categorias_balancetes c ON b.categoria_id = c.id 
        WHERE 1=1";
...
$sql .= " ORDER BY b.ano DESC, b.data_documento DESC, b.ordem";
...
$stmtAnos = $pdo->query("SELECT DISTINCT ano FROM balancetes ORDER BY ano DESC");
...
<head>
    ...
    <title>Gerenciar Balancetes - Admin FAP</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Gerenciar Balancetes</h1>
            <a href="balancete_form" class="bg-green-primary text-white px-6 py-3 rounded-lg hover:bg-green-600 transition-colors font-medium text-center">
                + Novo Balancete
            </a>
        </div>
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <?php if ($busca || $categoria || $ano): ?>
                        <a href="balancetes" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 transition-colors">
                            Limpar
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="overflow-x-auto">
                <table id="balancetesTable" class="w-full">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <span class="text-sm font-medium text-gray-700">
                                            <?php echo htmlspecialchars($bal['categoria_nome']); ?>
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="balancete_form?id=<?php echo $bal['id']; ?>" 
                                               class="text-blue-600 hover:text-blue-800 font-medium text-sm"
                                               title="Editar">
                                                ✏️
                                            </a>
                                            <a href="?toggle=<?php echo $bal['id']; ?>" 
                                            ...
                                            <a href="?deletar=<?php echo $bal['id']; ?>" 
