...
<div class="bg-gray-100 rounded-lg p-3 mb-2 border border-gray-200">
    <div class="flex items-center justify-between mb-2">
        ...
        <div class="flex items-center gap-2">
            ...
            <button onclick="abrirModalDocumento(<?= $ano['id'] ?>)" class="inline-flex items-center gap-1 bg-blue-600 text-white px-3 py-1 rounded text-xs font-semibold hover:bg-blue-700 transition-colors">
