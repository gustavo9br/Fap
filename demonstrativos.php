...
// Buscar demonstrativos por categoria
$demonstrativosPorCategoria = [];
foreach ($categorias as $categoria) {
    ...
    $demonstrativosPorCategoria[$categoria['id']] = $stmt->fetchAll();
}
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Demonstrativos - FAP Pádua</title>
            ...
            <div class="relative z-10">
                ...
                <nav class="mb-6">
                    <ol class="flex items-center gap-2 text-white text-sm">
                        ...
                        <li class="font-semibold">DEMONSTRATIVOS</li>
                    </ol>
                </nav>

                <!-- Título -->
                <h1 class="text-white text-2xl md:text-3xl font-bold border-l-4 border-white pl-4">DEMONSTRATIVOS</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="py-6 bg-gray-100">
    <div class="max-w-7xl mx-auto px-4">
        <?php foreach ($categorias as $categoria): ?>
            <?php 
            $demonstrativos = $demonstrativosPorCategoria[$categoria['id']] ?? [];
            if (empty($demonstrativos)) continue;
            ...
            <div id="<?php echo htmlspecialchars($categoria['slug']); ?>" class="bg-white rounded-2xl shadow-md p-8 mb-8">
                ...
                <?php foreach ($porAno as $ano => $demos): ?>
        ...
        <?php if (empty($categorias) || array_sum(array_map('count', $demonstrativosPorCategoria)) === 0): ?>
            <div class="text-center py-12">
                <svg class="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                <p class="text-gray-500 text-lg">Nenhum demonstrativo disponível no momento.</p>
            </div>
        <?php endif; ?>
    </div>
</section>
