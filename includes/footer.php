    ...
    <!-- Footer -->
    <footer class="bg-gradient-to-r from-blue-900 to-gray-900 text-white py-8 md:py-12 mt-16">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="border-t border-blue-800 pt-4 md:pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <p class="text-sm text-blue-100">© <?php echo date('Y'); ?> FAP. Todos os direitos reservados.</p>
            </div>
        </div>
    </footer>
